  ...
  return (
    <div className="lock-screen">
      ...
      <div className="lock-inner">
        ...
        <h1 className="lock-title">SIZGA<br />TAKLIFNOMA<br />KELDI</h1>
        <button className={`lock-btn ${shaking ? "shake" : ""}`} onClick={handleClick} aria-label="Ochish">
    ...
    <section className="message-section" ref={ref}>
      <div className={`message-card ${visible ? "slide-up" : ""}`}>
        ...
        <p className="message-text">
          ...
          birga nishonlashni niyat qildik. Sizni ushbu kechamizga samimiy taklif etamiz.
        </p>
        <p className="message-text">
    ...
    <section className="calendar-section" ref={ref}>
      <div className={`cal-wrap ${visible ? "fade-in" : ""}`}>
        ...
        <div className="cal-grid">
          ...
          {cells.map((d, i) => (
            <div key={i} className={`cal-cell ${d === weddingDay ? "wedding-day" : ""} ${!d ? "empty" : ""}`}>
              {d === weddingDay ? (
  ...
  return (
    <section className="gift-section" ref={ref}>
      <div className={`gift-wrap ${visible ? "slide-up" : ""}`}>
        ...
        <p className="gift-desc">Agar istasangiz, to'yonani kuyov kartasiga yuborishingiz mumkin.</p>
        ...
        <p className="card-hint">Karta raqamini nusxalab olishingiz yoki quyidagi tugmalar orqali Payme va Click'ni ochishingiz mumkin.</p>
        <div className="card-actions">
          <button className="card-btn primary" onClick={copy}>
            {copied ? "✓ NUSXALANDI!" : "RAQAMNI NUSXALASH"}
          </button>
          <div className="pay-btns">
            <a href="https://payme.uz" target="_blank" rel="noreferrer" className="card-btn pay">PAYME</a>
            <a href="https://my.click.uz" target="_blank" rel="noreferrer" className="card-btn pay">CLICK</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="countdown-section" ref={ref}>
      <div className={`countdown-wrap ${visible ? "fade-in" : ""}`}>
        ...
        <div className="countdown-grid">
          {[{ val: pad(days), label: "KUN" }, { val: pad(hours), label: "SOAT" }, { val: pad(minutes), label: "DAQIQA" }, { val: pad(seconds), label: "SONIYA" }].map(({ val, label }) => (
